...
**Durum:** Faz 0 ✅ · Faz 1 ✅ (6/7) · Faz 2 🚧 (registry + 5 node) · Faz 7 kısmen ✅
...
- ✅ 5 hedef platform (Runway, Kling, Veo, Luma, Midjourney)
- ✅ 3D Global Preview (Three.js)
- ✅ **Undo/Redo** (50 adım) + çoklu seçim + hızlı ekleme paleti
- ✅ **Otomatik test** — `npm test`, 100+ assertion, jsdom
- ✅ **Node registry** — yeni özne node'u = 1 dosya (6 değil)
- ✅ **2 çalışan preset** (Cyberpunk, Noir)
- ❌ Çoklu kayıt slotu
- ❌ Gerçek API entegrasyonu
- ❌ Çevrimdışı (CDN bağımlılığı sürüyor)
...
### Faz 3 — Prompt Engine 2.0 (1–2 hafta)
**Amaç:** Motorun mimarisini ölçeklenebilir kıl. Bugün: 500 satır tek fonksiyon + platform başına if/else.

- [ ] Platform adaptörleri — her platform ayrı modül
- [ ] Yeni platformlar — Sora, Pika, Hailuo, "Generic metin"
- [ ] Prompt lint — çelişki uyarıları (Noon + Night, Underwater + Dust)
- [ ] Karakter sayacı — platform limitine göre canlı uyarı
- [ ] Yapılandırılmış dışa aktarım — JSON şeması (API için)
- [ ] Varyant üretici — A/B/C varyantları, geçmişe grup olarak
- [x] **Test altyapısı** — öne çekildi. `npm test`: jsdom editör testleri +
      platform başına birebir prompt snapshot'ları. Registry refactor'ünün
      eşdeğerliğini bu snapshot'lar kanıtladı.

---

### Faz 4 — 3D önizleme pro (2–3 hafta)
**Amaç:** "Doğrulama" aracından "yönetmenlik" aracına çevir.

- [ ] Through-the-lens görünümü — seçili kamera gördüğü kare, gerçek FOV
- [ ] Çift yönlü bağlama — 3D'de sürükle → spatial fields güncellensin
- [ ] Kamera hareket önizlemesi — dolly/orbit/follow animate path
- [ ] Stilize GLTF modeller — insan, hayvan, böcek yerine gerçek mini modeller
- [ ] Işık kalitesi — gölgeler, gel renkli yansımalar
- [ ] Custom Location hacmi — ortam tipine göre zemin/duvar önerisi

**Neden?** Rakiplerden en bariz ayrışma noktası.
